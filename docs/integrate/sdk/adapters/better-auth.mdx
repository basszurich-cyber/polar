...
<Tabs>
  <Tab title="npm">
    ```bash Terminal
    npm install better-auth @spaire/better-auth @spaire/sdk
    ```
  </Tab>
  <Tab title="yarn">
    ```bash Terminal
    yarn add better-auth @spaire/better-auth @spaire/sdk
    ```
  </Tab>
  <Tab title="pnpm">
    ```bash Terminal
...
<Steps>
  ...
  <Step title="Configure BetterAuth Server">
    ...
    import { polar, checkout, portal, usage, webhooks } from "@spaire/better-auth"; // [!code ++]
    import { Polar } from "@spaire/sdk"; // [!code ++]
  ...
  <Step title="Configure BetterAuth Client">
    ...
    import { polarClient } from "@spaire/better-auth"; // [!code ++]
