...
<Tabs>
  <Tab title="npm">
    ```bash Terminal
    npm install zod @spaire/fastify
    ```
  </Tab>
  <Tab title="yarn">
    ```bash Terminal
    yarn add zod @spaire/fastify
    ```
  </Tab>
  <Tab title="pnpm">
    ```bash Terminal
    pnpm add zod @spaire/fastify
    ```
  </Tab>
</Tabs>
...
```typescript
import fastify from "fastify";
import { CustomerPortal } from "@spaire/fastify";
...
```typescript
import fastify from 'fastify'
import { Webhooks } from "@spaire/fastify";
