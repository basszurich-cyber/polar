...
<Tabs>
  <Tab title="npm">
    ```bash Terminal
    npm install zod @spaire/sveltekit
    ```
  </Tab>
  <Tab title="yarn">
    ```bash Terminal
    yarn add zod @spaire/sveltekit
    ```
  </Tab>
  <Tab title="pnpm">
    ```bash Terminal
    pnpm add zod @spaire/sveltekit
    ```
  </Tab>
</Tabs>
...
import { Checkout } from "@spaire/sveltekit";
...
import { CustomerPortal } from "@spaire/sveltekit";
...
import { Webhooks } from "@spaire/sveltekit";
